(function() {
    ...
    angular.module('directives', []).directive('scene', function() {
        return {
            restrict: 'E',
            ...
            link: function(scope, element, attrs){
                ...
                var dockHeight = dockWidth * 0.10;
                var dockMesh = new THREE.Mesh(
                    new THREE.PlaneGeometry(dockWidth, dockHeight),
                    new THREE.MeshPhongMaterial({
                        color: 0xffffff,
                        map: THREE.ImageUtils.loadTexture("images/black-banner.png"),
                        transparent: true,
                        opacity: 1
                    })
                );
                ...
                dock.pushImage("images/shapes/cube.png");
                dock.pushImage("images/shapes/sphere.png");
                dock.pushImage("images/shapes/cone.png");
                dock.pushImage("images/shapes/cylinder.png");
                ...
                // When an image is removed from the dock, add it to the container.
                ...
                var grid = new THREE.Mesh(new THREE.PlaneGeometry(10, 10),gridMat);
                grid.name = "grid";
                scene.add(grid);
